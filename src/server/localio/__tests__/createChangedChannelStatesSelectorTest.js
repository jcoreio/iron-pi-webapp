...
describe('createChangedChannelStateSelector', function () {
  ...
  it('works', () => {
    expect(selectChangedChannelStates(
      ...
      setChannelValues({channelId: '1', value: {rawDigitalInput: 0}})
    )).to.deep.equal([])
    ...
    expect(selectChangedChannelStates(
      ...
      setChannelValues({channelId: '1', value: {rawDigitalInput: 1}})
    )).to.deep.equal([
      {channelId: '1', mode: 'DIGITAL_INPUT', reversePolarity: false, rawInput: 1, systemValue: 1}
    ])
    ...
    expect(selectChangedChannelStates(
      ...
      setChannelValues(
        {channelId: '1', value: {rawDigitalInput: 1}},
        {channelId: '2', value: {rawAnalogInput: 6}},
      )
    ).sort((a, b) => parseInt(a.channelId) - parseInt(b.channelId))).to.deep.equal([
      {channelId: '1', mode: 'DIGITAL_INPUT', reversePolarity: false, rawInput: 1, systemValue: 1},
      {channelId: '2', mode: 'ANALOG_INPUT', rawInput: 6, systemValue: 6},
      {channelId: '4', mode: 'DIGITAL_OUTPUT', reversePolarity: false, safeState: 0, controlMode: 'LOCAL_CONTROL', controlValue: 1, rawOutput: 1},
      {channelId: '5', mode: 'DIGITAL_OUTPUT', reversePolarity: false, safeState: 0, controlMode: 'LOCAL_CONTROL', controlValue: 1, rawOutput: 1},
      {channelId: '6', mode: 'DIGITAL_OUTPUT', reversePolarity: false, safeState: 0, controlMode: 'LOCAL_CONTROL', controlValue: 1, rawOutput: 1},
    ])
    ...
    expect(selectChangedChannelStates(
      ...
      setChannelValues(
        {channelId: '3', value: {rawDigitalInput: 0}},
      )
    ).sort((a, b) => parseInt(a.channelId) - parseInt(b.channelId))).to.deep.equal([
      {channelId: '3', mode: 'DIGITAL_INPUT', reversePolarity: false, rawInput: 0, systemValue: 0},
      {channelId: '5', mode: 'DIGITAL_OUTPUT', reversePolarity: false, safeState: 0, controlMode: 'LOCAL_CONTROL', controlValue: 1, rawOutput: 1},
      {channelId: '6', mode: 'DIGITAL_OUTPUT', reversePolarity: false, safeState: 0, controlMode: 'LOCAL_CONTROL', controlValue: 1, rawOutput: 1},
    ])
  })
