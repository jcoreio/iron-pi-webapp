...
export default function createLocalIOChannelState(): GraphQLFieldConfig<any, Context> {
  return {
    ...
    subscribe(doc: any, {id}: {id: number}, context: Context): AsyncIterator<LocalIOChannelState> {
