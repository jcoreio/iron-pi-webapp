...
export default function updateMetadataItem(): graphql.GraphQLFieldConfig<any, Context> {
  return {
    ...
    resolve: async (doc: any, {item}: {item: MetadataItem}, context: Context): Promise<any> => {
